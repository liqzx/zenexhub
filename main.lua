...
local Window = Rayfield:CreateWindow({
   ...
   ConfigurationSaving = {
      Enabled = true,
      FolderName = ZenexhubConfig, -- Create a custom folder for your hub/game
      FileName = "Zenex"
   },

   Discord = {
      Enabled = true, -- Prompt the user to join your Discord server if their executor supports it
      Invite = "87E4ndUsdd", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
...
Rayfield:Notify({
   Title = "Welcome User, Thank you for using Zenex!",
...
local Paragraph = UniversalTab:CreateParagraph({Title = "Credits", Content = "Owner - Liqxz / Coowner - Sap"})
local GamesTab = Window:CreateTab("Games", 4483362458) -- Title, Image
local Section = GamesTab:CreateSection("Arsenal")
local Divider = GamesTab:CreateDivider()
